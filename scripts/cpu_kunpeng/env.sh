...
export SGLANG_KUNPENG_PP_LAYOUT=0  # PP layout: 0 = node_block (a node maps to one PP stage, legacy); 1 = interleave (every node hosts all PP stages: rin 0..7 -> PP0, 8..15 -> PP1). Deprecated alias: SGLANG_KUNPENG_PP_INTERLEAVE_IN_NODE=1

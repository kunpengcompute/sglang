...
struct CliArgs {
    ...
    #[arg(long, default_value = "cache_aware", value_parser = ["random", "round_robin", "cache_aware", "power_of_two", "bucket", "grouped_threshold", "consistent_hashing", "prefix_hash", "manual"], help_heading = "Routing Policy")]
    policy: String,
    ...
    #[arg(long, value_parser = ["random", "round_robin", "cache_aware", "power_of_two", "bucket", "grouped_threshold", "consistent_hashing", "prefix_hash", "manual"], help_heading = "PD Disaggregation")]

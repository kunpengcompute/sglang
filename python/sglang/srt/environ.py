...
class Envs:
    ...
    SGLANG_DEBUG_PP_MTP = EnvBool(False)
    ...
    # Fused RMSNorm + int8 quantize for the attention input projection on
    # Kunpeng 920F (skips a separate quant_kunpeng pass before the int8 GEMM).
    SGLANG_KUNPENG_QUANT_RMSNORM = EnvBool(False)
    ...
    SGLANG_KUNPENG_MAX_SEQ_LEN = EnvInt(4096)
